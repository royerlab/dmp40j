...
/**
 * Wrapper for library <b>TLDFMX_64</b><br>
 * This file was autogenerated by <a href="http://jnaerator.googlecode.com/">JNAerator</a>,<br>
 * a tool written by <a href="http://ochafik.com/">Olivier Chafik</a> that <a href="http://code.google.com/p/jnaerator/wiki/CreditsAndLicense">uses a few opensource projects.</a>.<br>
 * For help, please visit <a href="http://nativelibs4java.googlecode.com/">NativeLibs4Java</a> or <a href="http://bridj.googlecode.com/">BridJ</a> .
 */
@Library(value = "TLDFMX_64", dependencies = {"C:\\structure\\code\\dmp40j\\lib\\dmp40\\TLDFM_64.dll"}) 
@Runtime(CRuntime.class) 
public class TLDFMX_64Library {
	static {
		BridJ.register();
	}
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFM_set_USB_access_mode(@org.bridj.ann.CLong long instrumentHandle, IntValuedEnum<TLDFMX_64Library.TLDFM_Access_Mode > accessMode, Pointer<Byte > requestedKey, Pointer<Byte > accessKey) {
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFM_add_status_delegate(@org.bridj.ann.CLong long instrumentHandle, Pointer<TLDFMX_64Library.StatusUpdate > statusUpdateDelegate) {
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFM_get_hysteresis_parameters(@org.bridj.ann.CLong long instrumentHandle, IntValuedEnum<TLDFMX_64Library.TLDFM_Target > target, Pointer<org.bridj.CLong > pCount, Pointer<Double > pNonlinearFactor, Pointer<Double > arrayTresholdInverter, Pointer<Double > arrayWeightInverter) {
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFM_set_hysteresis_parameters(@org.bridj.ann.CLong long instrumentHandle, IntValuedEnum<TLDFMX_64Library.TLDFM_Target > target, @org.bridj.ann.CLong long count, double nonlinearFactor, Pointer<Double > arrayTresholdInverter, Pointer<Double > arrayWeightInverter) {
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFM_enabled_hysteresis_compensation(@org.bridj.ann.CLong long instrumentHandle, IntValuedEnum<TLDFMX_64Library.TLDFM_Target > target, Pointer<Short > pEnabled) {
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFM_enable_hysteresis_compensation(@org.bridj.ann.CLong long instrumentHandle, IntValuedEnum<TLDFMX_64Library.TLDFM_Target > target, short enable) {
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_init(Pointer<Byte > resourceName, short IDQuery, short resetDevice, Pointer<org.bridj.CLong > pInstrumentHandle) {
		return TLDFMX_init(Pointer.getPeer(resourceName), IDQuery, resetDevice, Pointer.getPeer(pInstrumentHandle));
	}
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_init(@Ptr long resourceName, short IDQuery, short resetDevice, @Ptr long pInstrumentHandle);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static native long TLDFMX_close(@org.bridj.ann.CLong long instrumentHandle);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static native long TLDFMX_reset(@org.bridj.ann.CLong long instrumentHandle);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_self_test(@org.bridj.ann.CLong long instrumentHandle, Pointer<Short > pSelfTestResult, Pointer<Byte > selfTestMessage) {
		return TLDFMX_self_test(instrumentHandle, Pointer.getPeer(pSelfTestResult), Pointer.getPeer(selfTestMessage));
	}
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_self_test(@org.bridj.ann.CLong long instrumentHandle, @Ptr long pSelfTestResult, @Ptr long selfTestMessage);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_error_query(@org.bridj.ann.CLong long instrumentHandle, Pointer<org.bridj.CLong > pErrorCode, Pointer<Byte > errorMessage) {
		return TLDFMX_error_query(instrumentHandle, Pointer.getPeer(pErrorCode), Pointer.getPeer(errorMessage));
	}
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_error_query(@org.bridj.ann.CLong long instrumentHandle, @Ptr long pErrorCode, @Ptr long errorMessage);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_error_message(@org.bridj.ann.CLong long instrumentHandle, @org.bridj.ann.CLong long errorCode, Pointer<Byte > errorMessage) {
		return TLDFMX_error_message(instrumentHandle, errorCode, Pointer.getPeer(errorMessage));
	}
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_error_message(@org.bridj.ann.CLong long instrumentHandle, @org.bridj.ann.CLong long errorCode, @Ptr long errorMessage);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_revision_query(@org.bridj.ann.CLong long instrumentHandle, Pointer<Byte > instrumentDriverRevision, Pointer<Byte > firmwareRevision) {
		return TLDFMX_revision_query(instrumentHandle, Pointer.getPeer(instrumentDriverRevision), Pointer.getPeer(firmwareRevision));
	}
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_revision_query(@org.bridj.ann.CLong long instrumentHandle, @Ptr long instrumentDriverRevision, @Ptr long firmwareRevision);
	/**
	 * Action/Status Functions<br>
	 * Original signature : <code>ViStatus TLDFMX_relax(ViSession, TLDFM_Target, ViBoolean, ViBoolean, ViReal64[], ViReal64[], ViInt32*)</code><br>
	 * <i>native declaration : lib\dmp40\TLDFMX.h:37</i>
	 */
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_relax(@org.bridj.ann.CLong long instrumentHandle, IntValuedEnum<TLDFMX_64Library.TLDFM_Target > devicePart, short isFirstStep, short reload, Pointer<Double > relaxPatternMirror, Pointer<Double > relaxPatternArms, Pointer<org.bridj.CLong > pRemainingSteps) {
		return TLDFMX_relax(instrumentHandle, (int)devicePart.value(), isFirstStep, reload, Pointer.getPeer(relaxPatternMirror), Pointer.getPeer(relaxPatternArms), Pointer.getPeer(pRemainingSteps));
	}
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_relax(@org.bridj.ann.CLong long instrumentHandle, int devicePart, short isFirstStep, short reload, @Ptr long relaxPatternMirror, @Ptr long relaxPatternArms, @Ptr long pRemainingSteps);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_measure_system_parameters(@org.bridj.ann.CLong long instrumentHandle, short isFirstStep, Pointer<Float > measuredZernikeAmplitudes, Pointer<Double > nextMirrorPattern, Pointer<org.bridj.CLong > pRemainingSteps) {
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_measure_system_parameters(@org.bridj.ann.CLong long instrumentHandle, short isFirstStep, @Ptr long measuredZernikeAmplitudes, @Ptr long nextMirrorPattern, @Ptr long pRemainingSteps);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_get_flat_wavefront(@org.bridj.ann.CLong long instrumentHandle, @org.bridj.ann.CLong long flatZernikes, Pointer<Float > measuredZernikeAmplitudes, Pointer<Double > deviceZernikeAmplitudes, Pointer<Double > voltagePattern) {
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_get_flat_wavefront(@org.bridj.ann.CLong long instrumentHandle, @org.bridj.ann.CLong long flatZernikes, @Ptr long measuredZernikeAmplitudes, @Ptr long deviceZernikeAmplitudes, @Ptr long voltagePattern);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static native long TLDFMX_set_single_voltage_setpoint(@org.bridj.ann.CLong long instrumentHandle, @org.bridj.ann.CLong long segmentID, double voltage);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_set_voltages_setpoint(@org.bridj.ann.CLong long instrumentHandle, Pointer<Double > mirrorVoltages) {
		return TLDFMX_set_voltages_setpoint(instrumentHandle, Pointer.getPeer(mirrorVoltages));
	}
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_set_voltages_setpoint(@org.bridj.ann.CLong long instrumentHandle, @Ptr long mirrorVoltages);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_calculate_single_zernike_pattern(@org.bridj.ann.CLong long instrumentHandle, IntValuedEnum<TLDFMX_64Library.TLDFMX_zernike_flag_t > zernike, double deviceZernikeAmplitude, Pointer<Double > mirrorPattern) {
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_calculate_single_zernike_pattern(@org.bridj.ann.CLong long instrumentHandle, int zernike, double deviceZernikeAmplitude, @Ptr long mirrorPattern);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_calculate_zernike_pattern(@org.bridj.ann.CLong long instrumentHandle, @org.bridj.ann.CLong long zernikes, Pointer<Double > deviceZernikeAmplitudes, Pointer<Double > mirrorPattern) {
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_calculate_zernike_pattern(@org.bridj.ann.CLong long instrumentHandle, @org.bridj.ann.CLong long zernikes, @Ptr long deviceZernikeAmplitudes, @Ptr long mirrorPattern);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static native long TLDFMX_set_flip_mode(@org.bridj.ann.CLong long instrumentHandle, @org.bridj.ann.CLong long flipMode);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_get_flip_mode(@org.bridj.ann.CLong long instrumentHandle, Pointer<org.bridj.CLong > pFlipMode) {
		return TLDFMX_get_flip_mode(instrumentHandle, Pointer.getPeer(pFlipMode));
	}
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_get_flip_mode(@org.bridj.ann.CLong long instrumentHandle, @Ptr long pFlipMode);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static native long TLDFMX_set_rotation_mode(@org.bridj.ann.CLong long instrumentHandle, @org.bridj.ann.CLong long rotation);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_get_rotation_mode(@org.bridj.ann.CLong long instrumentHandle, Pointer<org.bridj.CLong > pRotationMode) {
		return TLDFMX_get_rotation_mode(instrumentHandle, Pointer.getPeer(pRotationMode));
	}
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_get_rotation_mode(@org.bridj.ann.CLong long instrumentHandle, @Ptr long pRotationMode);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static native long TLDFMX_set_pattern_range_check(@org.bridj.ann.CLong long instrumentHandle, short enable);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_get_pattern_range_check(@org.bridj.ann.CLong long instrumentHandle, Pointer<Short > pEnabled) {
		return TLDFMX_get_pattern_range_check(instrumentHandle, Pointer.getPeer(pEnabled));
	}
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_get_pattern_range_check(@org.bridj.ann.CLong long instrumentHandle, @Ptr long pEnabled);
	/**
	 * Data Functions<br>
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_get_parameters(@org.bridj.ann.CLong long instrumentHandle, Pointer<Double > pMinimumZernikeAmplitude, Pointer<Double > pMaximumZernikeAmplitude, Pointer<org.bridj.CLong > pZernikeCount, Pointer<org.bridj.CLong > pMeasurementSteps, Pointer<org.bridj.CLong > pRelaxSteps) {
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_get_parameters(@org.bridj.ann.CLong long instrumentHandle, @Ptr long pMinimumZernikeAmplitude, @Ptr long pMaximumZernikeAmplitude, @Ptr long pZernikeCount, @Ptr long pMeasurementSteps, @Ptr long pRelaxSteps);
	/**
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_get_system_parameters(@org.bridj.ann.CLong long instrumentHandle, Pointer<org.bridj.CLong > pRotationMode, Pointer<org.bridj.CLong > pFlipMode, Pointer<Double > maxDeviceZernikeAmplitudes, Pointer<Short > isDataValid) {
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_get_system_parameters(@org.bridj.ann.CLong long instrumentHandle, @Ptr long pRotationMode, @Ptr long pFlipMode, @Ptr long maxDeviceZernikeAmplitudes, @Ptr long isDataValid);
	/**
	 * Helper Functions<br>
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	public static long TLDFMX_convert_measured_zernike_amplitudes(@org.bridj.ann.CLong long instrumentHandle, Pointer<Float > measuredZernikeAmplitudes, Pointer<Double > deviceZernikeAmplitudes) {
	...
	@Convention(Convention.Style.StdCall) 
	@org.bridj.ann.CLong 
	protected native static long TLDFMX_convert_measured_zernike_amplitudes(@org.bridj.ann.CLong long instrumentHandle, @Ptr long measuredZernikeAmplitudes, @Ptr long deviceZernikeAmplitudes);
}
